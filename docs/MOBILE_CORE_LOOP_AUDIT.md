> **Status (July 8, 2026): superseded by the integrated implementation.**
> This document describes the July 7 container-session prototype, which
> shipped batch capture as a bolt-on overlay (js/batch-scan.js, since
> removed). The same behavior — plus Add & List, cover-path parity, and loop
> metrics — is now implemented directly in [js/main.js](../js/main.js) and
> verified by [verify-batchscan.js](../verify-batchscan.js); see
> [CHANGELOG.md](../CHANGELOG.md) July 7 entries. Kept for the audit record.
