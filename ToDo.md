...
- [ ] **1. Initialize git** in `W:\Coding Projects\booksharez\` and commit prototype as-is
...
- [ ] **3. Fix prototype condition values** — `fair`/`poor` → `like_new` / `very_good` / `good` / `acceptable`
...
- [ ] **6. Implement real auth** — signup, login, logout, protected pages (replace fake login)
